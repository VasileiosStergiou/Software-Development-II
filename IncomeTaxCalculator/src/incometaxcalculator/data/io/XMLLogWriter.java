...
public class XMLLogWriter extends FileWriter {
  ...
  public void generateFile(int taxRegistrationNumber) throws IOException {    
    ...
    if (outputFile != null) {
      ...
      outputFileName = outputFilePath+"//"+taxRegistrationNumber + "_LOG.xml";
      
    }
    else {
      outputFileName = taxRegistrationNumber + "_LOG.xml";
      JOptionPane.showMessageDialog(null,"No folder was chosen. "+
                                          taxRegistrationNumber + "_LOG.xml file will be saved in the application folder");
    }
    outputStream = new PrintWriter(new java.io.FileWriter(outputFileName));
            
    LogWriter txt_log_writer = new LogWriter(outputStream, "xml", taxRegistrationNumber);
